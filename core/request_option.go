...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/YasminaAI/motor-go-sdk")
	headers.Set("X-Fern-SDK-Version", "v0.0.75")
	headers.Set("User-Agent", "github.com/YasminaAI/motor-go-sdk/0.0.75")
	return headers
}
